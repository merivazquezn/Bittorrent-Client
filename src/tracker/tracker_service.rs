...
impl ITrackerServiceV2 for TrackerServiceV2 {
    fn announce(&mut self, event: Option<Event>) -> Result<TrackerResponse, TrackerError> {
...
#[derive(Clone)]
pub struct MockTrackerServiceV2 {
    pub responses: Vec<Vec<Peer>>,
    pub response_index: usize,
}

impl ITrackerServiceV2 for MockTrackerServiceV2 {
...
mod tests {
    ...
    fn test_get_peers_failure_on_invalid_or_not_found_response() {
        ...
        let mut tracker_service = TrackerServiceV2::new(ClientInfo {
            peer_id,
            config,
            metainfo,
        });
